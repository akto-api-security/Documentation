...
In **Akto**, severity levels help teams prioritise security issues and test findings based on risk and impact. Akto allows you to manually update the severity of both **Issues** and **Test Results** directly from the dashboard.
...
{% step %}
Navigate to **API Security** → **Reports** → **Issues**.
{% endstep %}
