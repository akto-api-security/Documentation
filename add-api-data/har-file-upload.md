...
You can use this method if you quickly want to try out Akto. Akto can process HAR (Http ARchive) files and populate inventory from it. 
Follow these steps to upload a HAR file on Akto dashboard - 
