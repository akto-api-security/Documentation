# MCP Endpoint Shield - Jamf MDM Deployment
...
### 1. deploy_token.sh
* **Purpose**: Deploys AKTO_API_TOKEN to user's config directory
* **Run as**: Logged-in user (NOT root)
* **Jamf Parameter 4**: AKTO_API_TOKEN (encrypted)
* **Execution**: Before or with package installation

### 2. install_user_package.sh
...
#### Script 2: install_user_package.sh
...
* Parameter Values:
  * Parameter 4 (AKTO_API_TOKEN): `<YOUR_AKTO_TOKEN_HERE>`
...
**Symptoms**: Services fail to start, logs show "AKTO_API_TOKEN not configured"
...
| $4 | AKTO_API_TOKEN | Token for MCP Shield (encrypted) |
...
* [MCP Endpoint Shield Overview](mcp-endpoint-shield.md) - General installation and manual setup
* [MCP Endpoint Shield via Cursor Hooks](mcp-endpoint-shield-cursor-hooks.md) - Alternative deployment method
* [MCP Security](mcp-security.md) - Security concepts and best practices
