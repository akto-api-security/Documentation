...
Discover AI agents and MCP servers directly from Google Chrome or any Chromium-based browser (Edge, Brave, Opera, etc.). The Akto Chrome extension captures agent interactions in real-time as you browse.

## Installation

1. Install the Akto extension from the Chrome Web Store
...
* Google Chrome, Microsoft Edge, Brave, or other Chromium-based browser
