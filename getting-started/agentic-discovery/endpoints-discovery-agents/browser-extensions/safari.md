...
1. Install the Akto extension from the App Store
2. Enable the extension in Safari preferences
3. Configure your Akto dashboard connection
4. Start browsing your AI applications
...
- Safari on macOS (latest version recommended)
