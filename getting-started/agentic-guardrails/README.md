# Get Started with Agentic Guardrails
...
→ [Set Up MCP Gateway](../../agentic-guardrails/overview/akto-mcp-proxy.md)
...
→ [Set Up Agent Gateway](../../agentic-guardrails/overview/akto-agent-proxy.md)
...
- [Discover your agents](../agentic-discovery/) to get full visibility
- [Run security probes](../agentic-red-teaming/) to identify vulnerabilities
