...
**How can I disable logs generated by akto's eBPF traffic collector ?**  
  
You can utilize the `ENABLE_LOGS` environment variable, which accepts either `true` or `false`, to enable or disable logging as needed.
