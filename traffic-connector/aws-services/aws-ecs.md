...
1. Setup Akto data processor using the guide [here](../traffic-data-sources/data-processor.md). Keep the values `AKTO_MONGO_IP` and `AKTO_NLB_IP` handy, as we will need them later.
