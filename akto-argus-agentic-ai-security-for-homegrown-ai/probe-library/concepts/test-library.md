...
Akto offers the ability to add your own probes as YAML files, allowing you to execute personalized security probes  alongside automated probes developed by Akto against your agent components and MCP endpoints. This streamlines the testing process and increases efficiency in identifying agentic security vulnerabilities.
