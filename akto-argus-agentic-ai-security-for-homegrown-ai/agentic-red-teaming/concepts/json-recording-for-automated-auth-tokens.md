...
This feature is particularly useful for probing agent components that require authentication, such as LLM provider API calls, MCP server connections, or tool invocations requiring bearer tokens.
