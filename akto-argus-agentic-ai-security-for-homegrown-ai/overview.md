...
Begin by setting up [**Homegrown Agentic Discovery**](connectors/) to automatically identify AI agents, MCP servers, and GenAI applications running in your cloud. This establishes the inventory required for continuous scanning and runtime guardrails.
