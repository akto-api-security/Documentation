...
1. Install the helm chart for [hybrid-saas](hybrid-saas.md#helm-chart) and add the following attributes at the end of the helm install command. This will configure kafka to use SASL authentication:
...
2.  Configure producers to use SASL authentication.
    ...
    3. Similar configuration can also be added to the [eBPF](ebpf/ebpf.md) traffic connector.
