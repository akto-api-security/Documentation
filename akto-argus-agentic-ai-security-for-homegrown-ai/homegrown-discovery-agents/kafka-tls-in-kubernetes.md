...
4. Install the helm chart for [hybrid-saas](hybrid-saas.md#helm-chart) and add the following attribute at the end of the helm install command. This will configure kafka to use TLS on port `9093`.
...
4.  Configure producers to use TLS.
    ...
    2. Similar configuration can also be added to the [eBPF](ebpf/ebpf.md) traffic connector.
