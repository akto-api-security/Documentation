...
For continuous discovery of your infrastructure, consider setting up [homegrown discovery agents](/broken/pages/5cQGl9ICiAsmPErYVuoj) or [endpoints discovery agents](../../overview.md).
