...
1. Open **Akto Argus Dashboard → Connectors → MCP → MCP Recon**
2. Click **Connect**
...
<div data-with-frame="true"><figure><img src="../../../.gitbook/assets/image (225).png" alt="" width="563"><figcaption></figcaption></figure></div>
