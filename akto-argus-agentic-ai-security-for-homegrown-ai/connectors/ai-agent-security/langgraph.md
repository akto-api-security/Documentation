...
{% tabs %}
{% tab title="Via LangSmith (Telemetry)" %}
...
{% tab title="Via Hooks (Coming Soon)" %}
...
This integration method is not yet available. Check back for updates or reach out to us at [support@akto.io](mailto:support@akto.io) to register your interest.
{% endhint %}
{% endtab %}
{% endtabs %}
