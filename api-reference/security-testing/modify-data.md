...
<table data-full-width="true"><thead><tr><th width="370.6767578125">API</th><th>Description</th></tr></thead><tbody><tr><td><strong>POST /api/startTest</strong></td><td>Start a new scan run on the selected API collections or endpoints.</td></tr><tr><td><strong>POST /api/stopTest</strong></td><td>Stop an ongoing scan run before it completes.</td></tr></tbody></table>
