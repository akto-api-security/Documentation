...
{% openapi-operation spec="lastestscanresultv1" path="/api/importInBurp" method="post" %}
...
{% openapi-operation spec="lastestscanresultv1" path="/api/uploadRecordedFlow" method="post" %}
[OpenAPI lastestscanresultv1](https://raw.githubusercontent.com/akto-api-security/Documentation/refs/heads/main/.gitbook/assets/AktoSwagger.json)
{% endopenapi-operation %}
