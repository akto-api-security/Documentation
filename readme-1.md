---
cover: .gitbook/assets/Agentic Security Cover page (1).png
coverY: 0
---

# Getting Started with API Security

[Getting-Started](readme-1.md#getting-started) • [API Discovery](api-inventory-1/concepts/api-endpoints.md) • [API testing](api-security-testing/concepts/test.md) • [Add Test](test-editor/concepts/test-library.md) • [Join Discord community](https://discord.com/invite/Wpc6xVME4s)
